<cfoutput>
    <div class="orderHistoryBody">
            ...
            <div class="orderDiv" id="orderDiv">
                <form action="" method="post">
                    <div class = "d-flex justify-content-center">
                        <input type="text" class="historySearch" placeholder="Search for order history..." name="orderSearch" id="orderSearchInput">
                    </div>
                </form>
                <div class="noOrdersDiv d-none" id="noSearchFound">
                    <div class="d-flex flex-column justify-content-center align-items-center">
                        <img src="Assets/Images/cartEmpty.jpg" alt="" class = "mx-auto cartEmptyImg">
                        <span class="noOrderMessage" id="noOrderMessage">Oops! No matching orders for the search</span>
                ...
                <div class="noOrdersDiv" id="noOrdersDiv">
                    <div class="d-flex flex-column justify-content-center align-items-center">
                        <img src="Assets/Images/cartEmpty.jpg" alt="" class = "mx-auto cartEmptyImg">
                        <span class="noOrderMessage" id="noOrderMessage2">Oops! No orders placed. Let's change that.</span>
        ...
        <div class="pagination" id="pagination">
            <button id="prev" onclick="changePage('prev')" class="disabled scrollTop previous" disabled>Previous</button>
            <span id="pageNumber" class="pageNumber mt-2">1</span>
            <button id="next" onclick="changePage('next')" class="scrollTop next">Next</button>
        </div>
    </div>
</cfoutput>
